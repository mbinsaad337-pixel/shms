                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
                        <div class="mb-4 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-xl relative font-almarai whitespace-pre-line"
                            role="alert">
                            <span class="block sm:inline"><?php echo nl2br(e(session('success'))); ?></span>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.open(<?php echo json_encode(session('whatsapp_url'), 15, 512) ?>, '_blank');
                }
            });
        });
    </script>
...
<?php /**PATH C:\xampp\htdocs\Student_Housing_Management_System_PRD\shms\resources\views/layouts/app.blade.php ENDPATH**/ ?>