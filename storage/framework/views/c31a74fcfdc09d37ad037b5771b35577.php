...
<?php $__env->startSection('title', 'لوحة تحكم المركز'); ?>

<?php $__env->startSection('content'); ?>
    <div class="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h1 class="text-2xl md:text-3xl font-black text-primary font-cairo">مركز: <?php echo e(auth()->user()->center->name ?? 'غير محدد'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 mb-8">
                ...
                <div class="flex items-center justify-between font-cairo">
                    <div>
                        ...
                        <div class="flex items-baseline space-x-2 space-x-reverse">
                            <h3 class="text-3xl font-bold text-navy"><?php echo e(number_format($stats['students_count'])); ?></h3>
                            <span class="text-xs text-gray-400">كلي</span>
                        </div>
                        <div class="mt-2 text-xs">
                            <span class="text-red-500 font-bold"><?php echo e($stats['students_suspended']); ?></span>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 card-hover">
                <div class="flex items-center justify-between font-cairo">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-gold"><?php echo e(number_format($stats['pending_approval'])); ?></h3>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 card-hover">
                <div class="flex items-center justify-between font-cairo">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-navy font-almarai"><?php echo e($stats['remaining_seats']); ?></h3>
                        <p class="text-xs text-gray-400 mt-1">من إجمالي <?php echo e($stats['total_capacity']); ?></p>
                    </div>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 card-hover">
                <div class="flex items-center justify-between font-cairo">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-navy"><?php echo e($stats['on_leave_count']); ?></h3>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 card-hover">
                <div class="flex items-center justify-between font-cairo">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-navy font-almarai"><?php echo e($stats['meal_subscribers']); ?></h3>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-funds')): ?>
            <!-- Center Balance -->
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 card-hover">
                <div class="flex items-center justify-between font-cairo">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-navy font-almarai">
                            <?php echo e(number_format($stats['center_funds'], 0)); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
        <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-right">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recent_vouchers->count() > 0): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recent_vouchers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $voucher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                        <tr class="hover:bg-gray-50/50 transition-colors">
                                            <td class="px-8 py-4 font-mono text-sm text-primary font-bold">
                                                <?php echo e($voucher->voucher_number); ?>

                                            </td>
                                            <td class="px-8 py-4 font-almarai text-sm"><?php echo e($voucher->fund->name ?? '---'); ?></td>
                                            <td class="px-8 py-4">
                                                <?php
                                                ...
                                                ?>
                                                <span class="px-3 py-1 rounded-full text-xs font-bold font-almarai <?php echo e($bagdeClass); ?>">
                                                    <?php echo e($label); ?>

                                                </span>
                                            </td>
                                            <td class="px-8 py-4 font-bold text-gray-800 font-almarai">
                                                <?php echo e(number_format($voucher->amount, 2)); ?>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="4" class="px-8 py-8 text-center text-gray-400 font-almarai">لا توجد سندات مسجلة
                                            مؤخراً</td>
                                    </tr>
            ...
            <div class="card-premium overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($pending_approvals['students']) && auth()->user()->can('manage-students')): ?>
                        <a href="<?php echo e(route('students.index', ['status' => 'pending'])); ?>"
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-gray-800 group-hover:text-blue-700">
                                    <?php echo e($pending_approvals['students']); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($pending_approvals['leaves']) && auth()->user()->can('manage-leaves')): ?>
                        <a href="<?php echo e(route('leaves.index')); ?>"
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-gray-800 group-hover:text-teal-700">
                                    <?php echo e($pending_approvals['leaves']); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($pending_approvals['vouchers']) && auth()->user()->can('manage-vouchers')): ?>
                        <a href="<?php echo e(route('vouchers.index')); ?>"
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-gray-800 group-hover:text-purple-700">
                                    <?php echo e($pending_approvals['vouchers']); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($pending_approvals['budgets']) && auth()->user()->can('view-budgets')): ?>
                        <a href="<?php echo e(route('budgets.index')); ?>"
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-gray-800 group-hover:text-orange-700">
                                    <?php echo e($pending_approvals['budgets']); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($pending_approvals['food_budgets']) && auth()->user()->can('view-nutrition-budgets')): ?>
                        <a href="<?php echo e(route('nutrition.budgets.index')); ?>"
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-gray-800 group-hover:text-emerald-700">
                                    <?php echo e($pending_approvals['food_budgets']); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($pending_approvals['food_settlements']) && auth()->user()->can('view-nutrition-settlements')): ?>
                        <a href="<?php echo e(route('nutrition.settlements.index')); ?>"
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-gray-800 group-hover:text-amber-700">
                                    <?php echo e($pending_approvals['food_settlements']); ?>
        ...
        <div class="space-y-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->can('manage-users') || auth()->user()->can('manage-students') || auth()->user()->can('view-budgets') || auth()->user()->can('view-funds') || auth()->user()->can('manage-vouchers') || auth()->user()->can('view-rooms')): ?>
                <div class="card-premium p-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-funds')): ?>
                            <a href="<?php echo e(route('funds.index')); ?>"
                                class="flex items-center p-4 bg-navy/5 rounded-2xl hover:bg-navy hover:text-white transition-all group">
                                <div
                                    class="w-10 h-10 bg-white shadow-sm rounded-xl flex items-center justify-center text-navy ml-4">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage-vouchers')): ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-rooms')): ?>
                            <a href="<?php echo e(route('rooms.index', ['vacant' => 1])); ?>"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-violations')): ?>
            <!-- Recent Violations -->
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-right">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recent_violations->count() > 0): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recent_violations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $violation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <tr class="hover:bg-gray-50/50 transition-colors">
                                        <td class="px-8 py-5 font-bold text-gray-800 font-almarai">
                                            <?php echo e($violation->student->name_ar ?? 'طالب غير معروف'); ?>

                                        </td>
                                        <td class="px-8 py-5 text-sm font-almarai text-gray-600"><?php echo e($violation->type); ?></td>
                                        <td class="px-8 py-5">
                                            <span
                                                class="px-3 py-1 rounded-full text-[10px] font-bold font-almarai <?php echo e($violation->severity == 'severe' ? 'bg-red-50 text-red-600' : 'bg-orange-50 text-orange-600'); ?>">
                                                <?php echo e($violation->severity == 'severe' ? 'جسيمة' : 'متوسطة'); ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-absences')): ?>
            <!-- Recent Absences -->
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-right">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recent_absences->count() > 0): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recent_absences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $absence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <tr class="hover:bg-gray-50/50 transition-colors">
                                        <td class="px-8 py-5 font-bold text-gray-800 font-almarai">
                                            <?php echo e($absence->student->name_ar ?? 'طالب غير معروف'); ?>

                                        </td>
                                        <td class="px-8 py-5 text-sm font-mono text-gray-500"><?php echo e($absence->date->format('Y-m-d')); ?>

                                        </td>
                                        <td class="px-8 py-5">
                                            <span
                                                class="px-3 py-1 rounded-full text-xs font-bold font-almarai <?php echo e($absence->has_excuse ? 'bg-green-50 text-green-600' : 'bg-red-50 text-red-600'); ?>">
                                                <?php echo e($absence->has_excuse ? 'بعذر' : 'بدون عذر'); ?>
    ...
    <div class="bg-primary rounded-3xl p-8 text-white shadow-lg shadow-blue-900/20 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($active_activities->count() > 0): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $active_activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div class="bg-white/10 rounded-2xl p-4 border border-white/10 hover:bg-white/20 transition-all cursor-pointer">
                        <h4 class="font-bold font-almarai"><?php echo e($activity->name); ?></h4>
                        <p class="text-xs opacity-70 mt-1 font-almarai italic">
                            <?php echo e(\Carbon\Carbon::parse($activity->activity_date)->format('Y/m/d')); ?>
                            ...
                            <div class="space-y-4">
                                        ...
                                        <div class="max-h-40 overflow-y-auto custom-scrollbar space-y-1 pr-1">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                <label
                                                    ...
                                                    <input type="checkbox" name="student_id[]" value="<?php echo e($s->id); ?>"
                                                    ...
                                                    <div class="mr-3 text-right">
                                                        <p class="text-xs font-bold text-gray-800 font-cairo student-name">
                                                            <?php echo e($s->name_ar); ?>

                                                        </p>
                                                        <p class="text-[10px] text-gray-400 font-almarai"><?php echo e($s->barcode); ?></p>
                                                    </div>
                                                </label>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                        </div>
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-1 font-cairo text-right">تاريخ
                                        المخالفة</label>
                                    <input type="date" name="violation_date" value="<?php echo e(date('Y-m-d')); ?>" required
                                        class="w-full border-gray-200 rounded-xl p-3 focus:ring-red-500 font-almarai">
                                </div>
                                <div>
            ...
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    ...
                    <div class="px-8 pt-8 pb-6 bg-white">
                        ...
                        <form action="<?php echo e(route('commitments.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="space-y-4">
                                <div>
                                    <label
            ...
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    ...
                    <div class="px-8 pt-8 pb-6 bg-white">
                        ...
                        <form action="<?php echo e(route('absences.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="space-y-4">
                                <div>
                                    <label
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Student_Housing_Management_System_PRD\shms\resources\views/dashboard/center.blade.php ENDPATH**/ ?>