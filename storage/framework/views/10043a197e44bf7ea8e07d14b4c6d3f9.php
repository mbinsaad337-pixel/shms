...
<div class="print-only print-header-executive">
    ...
    <div class="header-content-grid">
        ...
        <div class="official-id-section">
            ...
            <h3 class="center-sub-ar"><?php echo e(auth()->user()->center?->name ?? 'مركز الأوائل الجامعي'); ?></h3>
            <div class="h-accent-gold"></div>
            <p class="dept-label"><?php echo e($department ?? 'الإدارة المركزية - منصة إدارة السكنات الطلابية'); ?></p>
        </div>

        <!-- Center: Branding Logos -->
        <div class="branding-logos-section">
            <div class="logos-flex-container">
                <img src="<?php echo e(asset('images/logos/alawayil_logo.png')); ?>" alt="Alawayil" class="h-14">
                <div class="vertical-gold-line"></div>
                <img src="<?php echo e(asset('images/logos/scs_logo.png')); ?>" alt="SCS" class="h-14">
            </div>
        </div>
        ...
        <div class="document-context-section">
            ...
            <div class="ctx-item">
                ...
                <span class="ctx-val font-mono"><?php echo e($number ?? '---'); ?></span>
            </div>
            <div class="ctx-item">
                <span class="ctx-label">تاريخ المستند:</span>
                <span class="ctx-val"><?php echo e(date('Y/m/d')); ?></span>
            </div>
            <div class="ctx-item">
    ...
    <div class="title-abstract-container">
        <h1 class="document-hero-title"><?php echo e($title ?? 'تقرير رسمي'); ?></h1>
...
<?php /**PATH C:\xampp\htdocs\Student_Housing_Management_System_PRD\shms\resources\views/partials/print_header.blade.php ENDPATH**/ ?>