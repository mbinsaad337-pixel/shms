...
<?php $__env->startSection('title', 'لوحة تحكم المدير العام'); ?>
        ...
        <div class="card-premium p-6 relative overflow-hidden group">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h3 class="text-3xl font-black text-navy"><?php echo e(number_format($stats['students_count'])); ?></h3>
                </div>
            </div>
            <div class="mt-4 flex items-center justify-between text-[10px] font-bold">
                <span class="text-blue-600">نسبة الإشغال العام:</span>
                <?php $occupancy = $stats['total_capacity'] > 0 ? ($stats['occupied_seats'] / $stats['total_capacity']) * 100 : 0; ?>
                <span class="bg-blue-50 text-blue-700 px-2 py-1 rounded"><?php echo e(round($occupancy)); ?>%</span>
            </div>
            <div class="mt-2 w-full bg-gray-50 h-1.5 rounded-full overflow-hidden">
                <div class="bg-blue-600 h-full transition-all duration-1000" style="width: <?php echo e($occupancy); ?>%"></div>
            </div>
        </div>
        ...
        <div class="card-premium p-6 relative overflow-hidden group">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h3 class="text-3xl font-black text-navy"><?php echo e(number_format($stats['total_liquidity'], 0)); ?> <span class="text-xs font-normal text-gray-400 font-cairo">ر.ي</span></h3>
                </div>
            </div>
        ...
        <div class="card-premium p-6 relative overflow-hidden group border-r-4 border-r-gold">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h3 class="text-3xl font-black text-navy"><?php echo e($stats['pending_budgets'] + $stats['pending_settlements']); ?></h3>
                </div>
            </div>
            <div class="mt-4 flex gap-2">
                <span class="text-[9px] font-bold bg-orange-100 text-orange-700 px-2 py-0.5 rounded"><?php echo e($stats['pending_budgets']); ?> طلبات عهد</span>
                <span class="text-[9px] font-bold bg-blue-100 text-blue-700 px-2 py-0.5 rounded"><?php echo e($stats['pending_settlements']); ?> تصفيات</span>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden group">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h3 class="text-3xl font-extrabold text-purple-700"><?php echo e($stats['centers_count']); ?></h3>
                </div>
            </div>
        ...
        <div class="lg:col-span-1 flex flex-col gap-6">
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden flex flex-col h-full">
                ...
                <div class="p-6 overflow-y-auto max-h-[600px] flex flex-col gap-4">
                    ...
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($pendingItems) > 0): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $pendingItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            ...
                            ?>
                            <div class="p-4 bg-gray-50 border border-gray-100 rounded-2xl transition-all hover:bg-white hover:shadow-md hover:border-<?php echo e($color); ?>-200 relative group">
                                <div class="flex items-center justify-between mb-2">
                                    <span class="px-2 py-0.5 rounded-full text-[9px] font-bold bg-<?php echo e($color); ?>-100 text-<?php echo e($color); ?>-700 uppercase tracking-tighter">
                                        <?php echo e($typeLabel); ?>

                                    </span>
                                    <span class="text-[9px] text-gray-400 font-bold">#<?php echo e($item['id']); ?></span>
                                </div>
                                <h4 class="text-sm font-bold text-gray-800 font-cairo mb-1 truncate"><?php echo e($centerName); ?></h4>
                                <div class="flex justify-between items-end">
                                    <div>
                                        <p class="text-[10px] text-gray-400 font-almarai italic mb-2">المبلغ: <?php echo e(number_format($amount, 2)); ?> ر.ي</p>
                                        <a href="<?php echo e($isBudget ? route('budgets.show', $item['id']) : route('settlements.show', $item['id'])); ?>" 
                                           class="text-[10px] font-bold text-<?php echo e($color); ?>-600 hover:underline">مراجعة والبت في الطلب ←</a>
                                    </div>
                                    <span class="text-[9px] text-gray-400"><?php echo e(\Carbon\Carbon::parse($item['created_at'])->diffForHumans()); ?></span>
                                </div>
                            </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-8 py-5 border-b border-gray-50 bg-gray-50/50 flex justify-between items-center">
                    ...
                    <a href="<?php echo e(route('centers.index')); ?>" class="text-xs font-bold text-gray-400 hover:text-primary transition-colors">عرض جميع المراكز <i class="fas fa-external-link-alt text-[9px]"></i></a>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full text-right">
                        ...
                        <tbody class="divide-y divide-gray-50 font-almarai">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $centers_performance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $center): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr class="hover:bg-blue-50/20 transition-colors group">
                                    <td class="px-8 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="w-10 h-10 bg-gray-50 rounded-xl flex items-center justify-center text-primary font-bold text-xs border border-gray-100 transition-colors group-hover:bg-white group-hover:shadow-sm">
                                                <?php echo e(mb_substr($center->name, 0, 1)); ?>

                                            </div>
                                            <div>
                                                <span class="font-bold text-gray-700 block text-sm"><?php echo e($center->name); ?></span>
                                                <span class="text-[10px] text-gray-400">كود: CTR-<?php echo e($center->id); ?></span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-8 py-4">
                                        <div class="flex flex-col items-center">
                                            <span class="text-sm font-bold text-gray-800"><?php echo e($center->students_count); ?></span>
                                            <div class="w-16 bg-gray-100 h-1 rounded-full mt-1 overflow-hidden">
                                                <?php $cp = $center->total_capacity > 0 ? ($center->students_count / $center->total_capacity) * 100 : 0; ?>
                                                <div class="bg-blue-500 h-full" style="width: <?php echo e($cp); ?>%"></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-8 py-4 font-bold text-gray-700 text-sm">
                                        <?php echo e(number_format($center->funds_sum_balance ?? 0, 2)); ?> ر.ي
                                    </td>
                                    <td class="px-8 py-4">
                                    ...
                                    <td class="px-8 py-4 text-left">
                                        <a href="<?php echo e(route('centers.show', $center)); ?>" class="text-gray-300 hover:text-primary transition-colors">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($centers_performance->isEmpty()): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Student_Housing_Management_System_PRD\shms\resources\views/dashboard/executive.blade.php ENDPATH**/ ?>