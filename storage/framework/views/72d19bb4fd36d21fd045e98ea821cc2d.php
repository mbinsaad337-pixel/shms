...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> - تسجيل الدخول</title>
...
<body class="font-cairo antialiased">
        ...
        <div class="w-full max-w-md relative z-10">
            ...
            <div class="flex flex-col items-center mb-10">
                <div class="flex items-center gap-6 mb-5">
                    <img src="<?php echo e(asset('images/logos/scs_logo.png')); ?>" alt="SCS"
            ...
            <p class="mt-8 text-center text-white/40 text-xs font-almarai">
                نظام إدارة السكن الطلابي &copy; <?php echo e(date('Y')); ?><br>
    ...
    <footer id="newsFooter" class="hidden bg-navy py-6 text-center">
        <p class="text-white/30 text-xs font-almarai">
            نظام إدارة السكن الطلابي &copy; <?php echo e(date('Y')); ?> — جمعية رعاية طالب العلم
        </p>
    </footer>
    ...
    <script>
        ...
        fetch("<?php echo e(route('news.public-feed')); ?>")
            .then(r => r.json())
            .then(items => {
...
<?php /**PATH C:\xampp\htdocs\Student_Housing_Management_System_PRD\shms\resources\views/layouts/guest.blade.php ENDPATH**/ ?>