    ...
    <div class="px-6 py-3 flex items-center justify-between relative">
        ...
        <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-10 py-1">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!auth()->user()->hasRole('super-admin')): ?>
                <img src="<?php echo e(auth()->user()->center ? auth()->user()->center->logo_url : asset('images/logos/alawayil_logo.png')); ?>" 
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-3 pl-2 border-r border-gray-100">
                <div class="text-right hidden sm:block">
                    <p class="text-xs font-black text-navy font-cairo leading-none mb-1"><?php echo e(auth()->user()->name); ?></p>
                ...
                <div class="relative group" x-data="{ open: false }" @click.away="open = false">
                    <button @click="open = !open" class="focus:outline-none flex items-center">
                        <img src="<?php echo e(auth()->user()->avatar ? asset('storage/' . auth()->user()->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode(auth()->user()->name) . '&background=004274&color=D4A044&bold=true'); ?>"
                            alt="User"
                    ...
                    <div x-show="open" x-transition.opacity style="display: none;"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('student')): ?>
                            <a href="<?php echo e(route('students.show', auth()->user()->student)); ?>"
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <a href="<?php echo e(route('profile.change_password.view')); ?>"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-navy transition-colors text-right">
...
<?php /**PATH C:\xampp\htdocs\Student_Housing_Management_System_PRD\shms\resources\views/partials/topbar.blade.php ENDPATH**/ ?>