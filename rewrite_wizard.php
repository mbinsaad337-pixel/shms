...
$file = 'resources/views/profile/complete-profile.blade.php';
...
$content = str_replace("</style>", $css_addition . "\n</style>", $content);

// 2. Add Progress Bar UI before the form
$progress_bar_ui = <<<HTML
        {{-- Progress Bar --}}
...
$form_open = '<form action="{{ route(\'profile.complete.update\') }}" method="POST" enctype="multipart/form-data" class="space-y-6 wizard-form" id="profileWizardForm">
...
$content = str_replace('<form action="{{ route(\'profile.complete.update\') }}" method="POST" enctype="multipart/form-data" class="space-y-6">', $progress_bar_ui . "\n" . $form_open, $content);

// 3. Transform Sections into Wizard Steps
$content = str_replace("{{-- ═══════════════════════════════ 1. المعلومات الشخصية ═══════════════════════════════ --}}",
"<div class=\"wizard-step active\" data-step=\"1\">\n            {{-- ═══════════════════════════════ 1. المعلومات الشخصية ═══════════════════════════════ --}}", $content);

$content = str_replace("{{-- ═══════════════════════════════ 2. العنوان الدائم ═══════════════════════════════ --}}",
"    <div class=\"flex justify-end gap-3 mt-6\">\n        <button type=\"button\" class=\"btn-next bg-primary text-white px-8 py-3 rounded-xl font-bold font-cairo shadow-lg hover:bg-primary/90 transition-all flex items-center gap-2\">التالي <i class=\"fas fa-arrow-left\"></i></button>\n    </div>\n</div>\n\n<div class=\"wizard-step\" data-step=\"2\">\n            {{-- ═══════════════════════════════ 2. العنوان الدائم ═══════════════════════════════ --}}", $content);

$content = str_replace("{{-- ═══════════════════════════════ 3. المؤهل التعليمي ═══════════════════════════════ --}}",
"    <div class=\"flex justify-between gap-3 mt-6\">\n        <button type=\"button\" class=\"btn-prev bg-gray-200 text-gray-700 px-8 py-3 rounded-xl font-bold font-cairo hover:bg-gray-300 transition-all flex items-center gap-2\"><i class=\"fas fa-arrow-right\"></i> السابق</button>\n        <button type=\"button\" class=\"btn-next bg-primary text-white px-8 py-3 rounded-xl font-bold font-cairo shadow-lg hover:bg-primary/90 transition-all flex items-center gap-2\">التالي <i class=\"fas fa-arrow-left\"></i></button>\n    </div>\n</div>\n\n<div class=\"wizard-step\" data-step=\"3\">\n            {{-- ═══════════════════════════════ 3. المؤهل التعليمي ═══════════════════════════════ --}}", $content);

$content = str_replace("{{-- ═══════════════════════════════ 5. ولي الأمر ═══════════════════════════════ --}}",
"    <div class=\"flex justify-between gap-3 mt-6\">\n        <button type=\"button\" class=\"btn-prev bg-gray-200 text-gray-700 px-8 py-3 rounded-xl font-bold font-cairo hover:bg-gray-300 transition-all flex items-center gap-2\"><i class=\"fas fa-arrow-right\"></i> السابق</button>\n        <button type=\"button\" class=\"btn-next bg-primary text-white px-8 py-3 rounded-xl font-bold font-cairo shadow-lg hover:bg-primary/90 transition-all flex items-center gap-2\">التالي <i class=\"fas fa-arrow-left\"></i></button>\n    </div>\n</div>\n\n<div class=\"wizard-step\" data-step=\"4\">\n            {{-- ═══════════════════════════════ 5. ولي الأمر ═══════════════════════════════ --}}", $content);

$content = str_replace("{{-- ═══════════════════════════════ 6. معلومات الأسرة ═══════════════════════════════ --}}",
"    <div class=\"flex justify-between gap-3 mt-6\">\n        <button type=\"button\" class=\"btn-prev bg-gray-200 text-gray-700 px-8 py-3 rounded-xl font-bold font-cairo hover:bg-gray-300 transition-all flex items-center gap-2\"><i class=\"fas fa-arrow-right\"></i> السابق</button>\n        <button type=\"button\" class=\"btn-next bg-primary text-white px-8 py-3 rounded-xl font-bold font-cairo shadow-lg hover:bg-primary/90 transition-all flex items-center gap-2\">التالي <i class=\"fas fa-arrow-left\"></i></button>\n    </div>\n</div>\n\n<div class=\"wizard-step\" data-step=\"5\">\n            {{-- ═══════════════════════════════ 6. معلومات الأسرة ═══════════════════════════════ --}}", $content);

$content = str_replace("{{-- ═══════════════════════════════ 7. المرفقات الثبوتية ═══════════════════════════════ --}}",
"    <div class=\"flex justify-between gap-3 mt-6\">\n        <button type=\"button\" class=\"btn-prev bg-gray-200 text-gray-700 px-8 py-3 rounded-xl font-bold font-cairo hover:bg-gray-300 transition-all flex items-center gap-2\"><i class=\"fas fa-arrow-right\"></i> السابق</button>\n        <button type=\"button\" class=\"btn-next bg-primary text-white px-8 py-3 rounded-xl font-bold font-cairo shadow-lg hover:bg-primary/90 transition-all flex items-center gap-2\">التالي <i class=\"fas fa-arrow-left\"></i></button>\n    </div>\n</div>\n\n<div class=\"wizard-step\" data-step=\"6\">\n            {{-- ═══════════════════════════════ 7. المرفقات الثبوتية ═══════════════════════════════ --}}", $content);

$content = str_replace('<div class="bg-gradient-to-l from-gray-800 to-gray-900 rounded-2xl p-6 text-right">',
"    <div class=\"flex justify-between gap-3 mt-6\">\n        <button type=\"button\" class=\"btn-prev bg-gray-200 text-gray-700 px-8 py-3 rounded-xl font-bold font-cairo hover:bg-gray-300 transition-all flex items-center gap-2\"><i class=\"fas fa-arrow-right\"></i> السابق</button>\n        <button type=\"button\" class=\"btn-next bg-primary text-white px-8 py-3 rounded-xl font-bold font-cairo shadow-lg hover:bg-primary/90 transition-all flex items-center gap-2\">التالي <i class=\"fas fa-arrow-left\"></i></button>\n    </div>\n</div>\n\n<div class=\"wizard-step\" data-step=\"7\">\n            <div class=\"bg-gradient-to-l from-gray-800 to-gray-900 rounded-2xl p-6 text-right\">", $content);

$submit_btn_html = <<<HTML
...
HTML;
$content = preg_replace('/<div class="pb-8">.*?<\/div>/s', $submit_btn_html, $content, 1);
...
$content = preg_replace('/\/\/ --- Ultra-Reliable Auto-Save Draft Feature ---.*?form\.addEventListener\(\'submit\'/s', $new_js . "\n\n    form.addEventListener('submit'", $content, 1);
