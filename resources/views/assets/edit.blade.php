                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <span id="currency_suffix"
                                class="absolute left-5 top-1/2 -translate-y-1/2 text-gray-300 font-almarai text-xs">{{ $asset->currency_symbol }}</span>
                        </div>
                    </div>
                    <div>
                        ...
                        <select name="currency" id="currency_select" required
                            ...
                            @foreach (\App\Models\Fund::CURRENCIES as $code => $label)
                                <option value="{{ $code }}"
                                    {{ $code == old('currency', $asset->currency) ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
