...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30 py-8" dir="rtl">
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            {{-- Form Container --}}
            <form id="profileForm" action="{{ route('profile.complete.update') }}" method="POST"
                    ...
                    <div class="section-body grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="surname" value="{{ old('surname', $student->surname) }}"
                                class="field-input @error('surname') border-red-500 @enderror" placeholder="اللقب / الكنية">
                            @error('surname')
                                <p class="text-red-500 text-[10px] font-bold mt-1 font-cairo"><i
                                        class="fas fa-exclamation-circle ml-1"></i> {{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" name="dependents_count"
                                ...
                                max="30" class="field-input @error('dependents_count') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="tel" name="phone" value="{{ old('phone', $student->phone) }}" required
                                class="field-input @error('phone') border-red-500 @enderror" placeholder="07XXXXXXXX">
                            @error('phone')
                                <p class="text-red-500 text-[10px] font-bold mt-1 font-cairo"><i
                                        class="fas fa-exclamation-circle ml-1"></i> {{ $message }}</p>
                            @enderror
                    ...
                    <div class="section-body grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="last_certificate"
                                value="{{ old('last_certificate', $student->last_certificate) }}" class="field-input"
                                placeholder="ثانوية عامة / بكالوريوس / ...">
                        </div>
                        <div>
                            <label class="field-label">التخصص</label>
                            <input type="text" name="last_cert_major"
                                value="{{ old('last_cert_major', $student->last_cert_major) }}" class="field-input"
                                placeholder="التخصص">
                        </div>
                        <div>
                            <label class="field-label">التقدير</label>
                            <select name="last_cert_grade" class="field-select">
                        ...
                        <div>
                            ...
                            <input type="number" name="graduation_year"
                                ...
                                max="2030" placeholder="2024" class="field-input">
                        </div>
                        <div>
                            <label class="field-label">المدرسة / الجهة المتخرج منها</label>
                            <input type="text" name="graduated_school"
                                value="{{ old('graduated_school', $student->graduated_school) }}" class="field-input"
                    ...
                    <div class="section-body grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="college" value="{{ old('college', $student->college) }}"
                                required class="field-input @error('college') border-red-500 @enderror">
                            @error('college')
                                <p class="text-red-500 text-[10px] font-bold mt-1 font-cairo"><i
                                        class="fas fa-exclamation-circle ml-1"></i> {{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select name="academic_level" required class="field-select">
                                @foreach (['1' => 'الأول', '2' => 'الثاني', '3' => 'الثالث', '4' => 'الرابع', '5' => 'الخامس', '6' => 'السادس', '7' => 'السابع', '8' => 'الثامن', 'superior' => 'دراسات عليا'] as $v => $l)
                                    <option value="{{ $v }}"
                                        {{ old('academic_level', $student->academic_level) == $v ? 'selected' : '' }}>
                                        المستوى
                                        {{ $l }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="current_academic_year"
                                ...
                                placeholder="2024/2025" class="field-input">
                        </div>
                        <div>
                        ...
                        <div class="md:col-span-3">
                            ...
                            <textarea name="skills" rows="2" class="field-input resize-none"
