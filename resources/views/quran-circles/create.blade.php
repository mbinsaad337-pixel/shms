...
@section('content')
    <div
        ...
        <div>
            <h1 class="text-3xl font-black text-navy font-cairo">إنشاء حلقة جديدة</h1>
            <p class="text-gray-400 font-almarai text-sm mt-1">تجهيز البيانات الأساسية للمجموعة التعليمية</p>
        </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-8">
            <form action="{{ route('quran-circles.store') }}" method="POST">
                @csrf
                <div class="space-y-6">
                    <div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4" x-data="{ type: '{{ old('type', 'memorization') }}' }">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4"
                            ...
                            class="w-full rounded-xl border-gray-200 focus:border-gold focus:ring-gold shadow-sm bg-gray-50/50 p-3 font-almarai">{{ old('description') }}</textarea>
                    </div>
