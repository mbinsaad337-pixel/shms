        ...
        <form action="{{ route('commitments.update', $commitment->id) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="date" name="date" value="{{ old('date', $commitment->date->format('Y-m-d')) }}" class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-sm font-mono outline-none focus:ring-2 focus:ring-navy/10">
                </div>
                <div>
