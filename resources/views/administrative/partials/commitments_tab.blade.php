                ...
                <table class="w-full text-right text-sm">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-gray-50/60 transition-colors">
                            <td class="px-5 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[10px] text-gray-400 font-mono">{{ $c->student->student_number ?? '' }}</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-5 py-4">
                            ...
                            <td class="px-5 py-4 text-center"><span class="text-xs font-mono text-gray-500">{{ $c->date->format('Y-m-d') }}</span></td>
