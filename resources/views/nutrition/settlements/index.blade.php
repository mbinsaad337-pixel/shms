                    ...
                    ($settlement->status === 'submitted' ? 'bg-yellow-100 text-yellow-700' :
                        ...
                        <div class="p-5 space-y-3">
                            ...
                            <div class="flex justify-between items-center text-sm">
                                ...
                                <span class="font-bold text-red-600  ">{{ number_format($settlement->total_expenses, 2) }} {{ currency_symbol() }}</span>
                            </div>
                            <div class="flex justify-between items-center text-sm">
                                <span class="text-gray-400 font-cairo">إجمالي مديونية الموردين:</span>
                                <span class="font-bold text-indigo-700  ">{{ number_format($settlement->total_debt, 2) }} {{ currency_symbol() }}</span>
                            </div>
