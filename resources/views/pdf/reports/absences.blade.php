...
<table class="signatures-table">
    <tr>
        <td>
            ...
            <div class="sign-name">
                 @php
                      $housing_manager = \App\Models\User::role('housing-manager')->where('center_id',$absence->student->center_id)->get();
                @endphp
        ...
        <td>
            ...
            <div class="sign-name">
                @php
                      $center_manager = \App\Models\User::role('center-manager')->where('center_id',$absence->student->center_id)->get();
                @endphp
